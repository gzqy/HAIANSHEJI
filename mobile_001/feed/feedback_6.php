...
function metlabel_feedback6($fid,$mobile){
	...
	// break;
	case 3:
	$list[input]="<textarea name='para$list[id]' placeholder='{$list[description]}'></textarea>";
	break; 
	case 4:
	$i=0;
    ...
    if($met_memberlogin_code==1){
				...
				$metinfo.="<input name='code' type='text' class='code' id='code' placeholder='验证码' size='6' maxlength='8'>";
