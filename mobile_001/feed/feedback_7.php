...
function metlabel_feedback7($fid,$mobile){
	...
	// 		$array  = array(
	// 	"<div class='form-1'><i><img src="."../templates/mobile_001/images/img/me.png"."></i>","</div><div class='form-1'><i><img src='../templates/mobile_001/images/img/phone.png' ></i>    ","</div><div class='form-2'><div class='formst'>","</div><div class='formst'>","</div></div><label><div class='formst'>项目需求</label>"
	// );
 //   	foreach($fd_para as $key=>$val){
