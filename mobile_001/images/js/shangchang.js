 $(function(){
		$("header>img").animate({top: '130px', opacity: 1}, 500);
		$(".headeroneem").animate({top: '185px', opacity: 1}, 500);
		$("header>p").animate({left: '50%', opacity: 1}, 600);
		setTimeout(function() {
