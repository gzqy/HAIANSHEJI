$(function(){
	...
	setTimeout(function() {
		$('.banntit').animate({top: '190px',opacity: 1},500);
		$('.banntit>p').animate({bottom: '6px',opacity: 1},500);
		$('.bannblue').animate({top: '400px',opacity:1},1000,function(){
...
/*投资引领 寻找风口*/
$(function(){
	$(".invettitle").hover(function(){
		$_this=$(this);
		var index=$_this.index();
		$(".invementcontentbox ul").eq(index).show().siblings("ul").hide();
		$_this.addClass('bgf9').siblings().removeClass('bgf9');
		$_this.find('span').addClass('top36');
		$_this.siblings().find('span').removeClass('top36');
		$_this.find('img').addClass('top45');
		$_this.siblings().find('img').removeClass('top45');
		$_this.find('em').addClass('colorfff');
		$_this.siblings().find('em').removeClass('colorfff');
	});
});
/*了解海岸*/
$(function(){
	$(".knowusmaintitbox li").hover(function(){
		$_this=$(this);
		var index=$_this.index();
		$(".knowuspicbox li").eq(index).show().siblings("li").hide();
		$(".knowusmaintxtbox li").eq(index).show().siblings("li").hide();
		$_this.css('backgroundImage', 'url(../templates/res017/images/wenlv/knowustitfocuslibg.png)');
		$_this.siblings('li').css('backgroundImage', 'inherit');
	});
});

/*老体字hover切换*/
$(function(){
	var laotialj = "../templates/res017/images/wenlv/";
...
$(function(){
	$(document).scroll(function(event) { 
		...
		if($(this).scrollTop()>3100){
			//中间
			 $(".commontourismctn").animate({top: 27,opacity: 1}, 400);
		 } 
		if($(this).scrollTop()>3300){
			//左边列
             $(".commonulleft li").eq(0).animate({left: 0,opacity: 1}, 400);
             $(".commonulleft li").eq(1).animate({left: 50,opacity: 1}, 400);
             $(".commonulleft li").eq(2).animate({left: 100,opacity: 1}, 400);
             $(".commonulleft li").eq(3).animate({left: 150,opacity: 1}, 400);
             $(".commonulleft li").eq(4).animate({left: 200,opacity: 1}, 400);
             //右边列
             $(".commonulright li").eq(0).animate({right: 0,opacity: 1}, 400);
             $(".commonulright li").eq(1).animate({right: 50,opacity: 1}, 400);
             $(".commonulright li").eq(2).animate({right: 100,opacity: 1}, 400);
             $(".commonulright li").eq(3).animate({right: 150,opacity: 1}, 400);
             $(".commonulright li").eq(4).animate({right: 200,opacity: 1}, 400);
		}
		if($(this).scrollTop()>5750){
             $(".buildprojectcenter").addClass('buildprojectctnturn'); 
		}
	});
});
/*绿色边框的hover事件*/
...
$(function(){
	...
	$(".lunbodownbtn").click(function(event) {
		...
		for(var i=0;i<len;i++){
			...
			$_this.find(".qspan").eq(i).find('span').css({backgroundImage:"url(../templates/res017/images/wenlv/"+imgsarr[currentindex]+")",backgroundPosition:"-"+i*155+"px 0"});
		}
	...
	function qini(){
		...
		for(var i=0;i<len;i++){
			...
			$this.find(".qspan").eq(i).find('span').css({backgroundImage:"url(../templates/res017/images/wenlv/"+imgsarr[currentindex]+")",backgroundPosition:"-"+i*155+"px 0"});
		}
	}
	//点击事件
...
$(function(){
	...
	$(".lunbodownbtn1").click(function(event) {
		...
		for(var i=0;i<len2;i++){
			$_this.eq(0).append("<div class='qspan'><span></span></div>");
			$_this.find(".qspan").eq(i).find('span').css({backgroundImage:"url(../templates/res017/images/wenlv/"+imgsarr2[currentindex2]+")",backgroundPosition:"-"+i*155+"px 0"});
		}
	...
	function qini(len=7){
		...
		for(var i=0;i<len;i++){
			$this.append("<div class='qspan'><span></span></div>");
			$this.find(".qspan").eq(i).find('span').css({backgroundImage:"url(../templates/res017/images/wenlv/"+imgsarr2[currentindex2]+")",backgroundPosition:"-"+i*155+"px 0"});
		}
	}
	//点击事件
	function togg($_mytar,len){
...
$(function(){
	...
	$(".lunbodownbtn2").click(function(event) {
		...
		for(var i=0;i<len3;i++){
			$_this.eq(0).append("<div class='qspan'><span></span></div>");
			$_this.find(".qspan").eq(i).find('span').css({backgroundImage:"url(../templates/res017/images/wenlv/"+imgsarr3[currentindex3]+")",backgroundPosition:"-"+i*155+"px 0"});
		}
	...
	function qini(len=7){
		...
		for(var i=0;i<len;i++){
			$this.append("<div class='qspan'><span></span></div>");
			$this.find(".qspan").eq(i).find('span').css({backgroundImage:"url(../templates/res017/images/wenlv/"+imgsarr3[currentindex3]+")",backgroundPosition:"-"+i*155+"px 0"});
		}
	}
	//点击事件
	function togg($_mytar,len){
