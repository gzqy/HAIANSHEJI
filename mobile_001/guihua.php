...
<html lang="en" style="font-size: 12px;">
	<head>
		...
		<link rel="stylesheet" href="{$img_url}css/guihua/common.css">
		<link rel="stylesheet" href="{$img_url}css/comform.css">
		<link rel="stylesheet" href="{$img_url}css/guihua/styles.css">
		<link rel="stylesheet" href="{$img_url}css/guihua/swiper.min.css">
		<script src="{$img_url}js/guihua/jquery-1.11.0.min.js"></script>
		<script src="{$img_url}js/guihua/swiper.min.js"></script>
		<script src="{$img_url}js/guihua/publicRem.js"></script>
		<script>
			$(function(){
...
<body style="background:#fff">
	<div class="marketplace-section">
		<div class="banner">
			<div class="content">
				<img class="en" src="{$img_url}img/guihua/market_banner_en.png" alt="">
				<p class="planing">商场规划设计</p>
				<p class="brand">19年行业领先品牌，300位设计团队精英</p>
				<div class="kind">
					<p class="contact">商业广场设计 / 购物广场设计 / 百货广场设计 / 商业街规划</p>
				</div>
				<a href="#div1" class="order">立即预约</a>
				<div class="updown">
					<a href="#div1" class="down"></a>
				</div>
			</div>
		</div>
			<!-- form表单 -->
...
-->  
  ...
  <!-- form表单 -->  
		<div class="market-design-service">
			<div class="title">
				<span class="item">商场设计服务领域</span>
			</div>
			<p class="describe">还原商业空间的本质体现其独有的风格、个性、及商业价值
			</p>
			<div class="colum">
				<span class="item">
					<img class="num" src="{$img_url}img/guihua/market-num1.png" alt="">
					<span class="tip">商业综合体设计</span>
				</span>
				<span class="item">
					<img class="num" src="{$img_url}img/guihua/market-num2.png" alt="">
					<span class="tip">商场设计</span>
				</span>
			</div>
			<div class="colum1">
					<span class="item">
						<img class="num1" src="{$img_url}img/guihua/market-num3.png" alt="">
						<span class="tip">购物中心设计</span>
					</span>
					<span class="item">
						<img class="num1" src="{$img_url}img/guihua/market-num4.png" alt="">
						<span class="tip">商业空间设计</span>
					</span>
					<span class="item">
						<img class="num1" src="{$img_url}img/guihua/market-num5.png" alt="">
						<span class="tip">精品超市设计</span>
					</span>
				</div>
		</div>
					...
					<div class="swiper-container design-banner">
						<div class="swiper-wrapper">
							<div class="swiper-slide ">
								<img class="pic" src="{$img_url}img/guihua/market_content_planing1.png" alt="">
								<p class="tip">整体规划设计</p>
								<p class="describe">以专业经验对商业用地进行规划，为发展商团队提供合理的商业 布局方案，为后续招商、设计工作和项目成功运营奠定基础</p>
								<div class="item">
									<span class="prev"><img src="{$img_url}img/guihua/market_content_left.png" alt=""></span>
									<span class="content"><img src="{$img_url}img/guihua/market_content_planing2.png" alt=""></span>
									<span class="next"><img src="{$img_url}img/guihua/market_content_right.png" alt=""></span>
								</div>
							</div>
							<div class="swiper-slide">
								<img class="pic" src="{$img_url}img/guihua/market_content_bulid1.png" alt="">
								<p class="tip">建筑外观设计</p>
								<p class="describe">通过综合体各部分的合理规划布局和深入的建筑设计，从城市尺度塑造商业节奏和整体形象</p>
								<div class="item">
									<span class="prev"><img src="{$img_url}img/guihua/market_content_left.png" alt=""></span>
									<span class="content"><img src="{$img_url}img/guihua/market_content_bulid2.png" alt=""></span>
									<span class="next"><img src="{$img_url}img/guihua/market_content_right.png" alt=""></span>
								</div>
							</div>
							<div class="swiper-slide">
								<img class="pic" src="{$img_url}img/guihua/market_content_space1.png" alt="">
								<p class="tip">商业空间设计</p>
								<p class="describe">准确的商业环境调研和科学分析、掌握影响购物中心发展的静态和动态变量，是做好成功商业规划的前提</p>
								<div class="item">
									<span class="prev"><img src="{$img_url}img/guihua/market_content_left.png" alt=""></span>
									<span class="content"><img src="{$img_url}img/guihua/market_content_space2.png" alt=""></span>
									<span class="next"><img src="{$img_url}img/guihua/market_content_right.png" alt=""></span>
								</div>
							</div>
							<div class="swiper-slide">
								<img class="pic" src="{$img_url}img/guihua/market_content_light1.png" alt="">
								<p class="tip">灯光设计</p>
								<p class="describe">用灯光营造及提升商业氛围，通过灯光对建筑、室内空间、景观等进行强化或再塑，加强载体表现力，树立现代商业新标杆</p>
								<div class="item">
									<span class="prev"><img src="{$img_url}img/guihua/market_content_left.png" alt=""></span>
									<span class="content"><img src="{$img_url}img/guihua/market_content_light2.png" alt=""></span>
									<span class="next"><img src="{$img_url}img/guihua/market_content_right.png" alt=""></span>
								</div>
							</div>
							<div class="swiper-slide">
								<img class="pic" src="{$img_url}img/guihua/market_content_view1.png" alt="">
								<p class="tip">导视系统设计</p>
								<p class="describe">借助由形象LOGO、导向标识及广告系统组成的视觉设计，紧随信息科技的发展，率先进入多媒体信息数据交互的领域</p>
								<div class="item">
									<span class="prev"><img src="{$img_url}img/guihua/market_content_left.png" alt=""></span>
									<span class="content"><img src="{$img_url}img/guihua/market_content_view2.png" alt=""></span>
									<span class="next"><img src="{$img_url}img/guihua/market_content_right.png" alt=""></span>
								</div>
							</div>
						</div>
		...
		<div class="market_position">
			...
			<div class="lower">
				<div class="item">
					<img src="{$img_url}img/guihua/market_position_icon1.png" alt="">
					<span>商业综合体策划</span>
				</div>
				<div class="item">
					<img src="{$img_url}img/guihua/market_position_icon2.png" alt="">
					<span>商业体业态定位</span>
				</div>
				<div class="item">
					<img src="{$img_url}img/guihua/market_position_icon3.png" alt="">
					<span>建筑、景观规划设计</span>
				</div>
				<div class="item">
					<img src="{$img_url}img/guihua/market_position_icon4.png" alt="">
					<span>室内空间设计</span>
				</div>
			</div>
		</div>
	  <div class="market-principle">
			<div class="title">
		...
		<div class="market_system">
			...
			<div class="system_slide">
				<div class="swiper-container system_banner">
						<div class="swiper-wrapper">
							<div class="swiper-slide">
								<img  class="system_logo" src="{$img_url}img/guihua/grinding_value.png" alt="">
								<div class="describe">
									<p class="caption">打磨价值</p>
									<p><img src="{$img_url}img/guihua/market_mark.png" alt=""><span>领先施工工艺工法</span></p>
									<p><img src="{$img_url}img/guihua/market_mark.png" alt=""><span>严谨科学施工管理</span></p>
									<p><img src="{$img_url}img/guihua/market_mark.png" alt=""><span>设计效果完美呈现</span></p>
								</div>
							</div>
							<div class="swiper-slide">
								<img  class="system_logo" src="{$img_url}img/guihua/construction_building.png" alt="">
								<div class="describe">
									<p class="caption">建构价值</p>
									<p><img src="{$img_url}img/guihua/market_mark.png" alt=""><span>系统化整合设计</span></p>
									<p><img src="{$img_url}img/guihua/market_mark.png" alt=""><span>艺术化视觉张力</span></p>
									<p><img src="{$img_url}img/guihua/market_mark.png" alt=""><span>情感化个性体验</span></p>
								</div>
							</div>
							<div class="swiper-slide">
								<img  class="system_logo" src="{$img_url}img/guihua/finding_value.png" alt="">
								<div class="describe">
									<p class="caption">发现价值</p>
									<p><img src="{$img_url}img/guihua/market_mark.png" alt=""><span>消费环境洞察</span></p>
									<p><img src="{$img_url}img/guihua/market_mark.png" alt=""><span>竞争环境分析</span></p>
									<p><img src="{$img_url}img/guihua/market_mark.png" alt=""><span>商业趋势观察</span></p>
									<p><img src="{$img_url}img/guihua/market_mark.png" alt=""><span>差异化价值定位</span></p>
								</div>
							</div>
						</div>
...
if($lang_gui_ok){
foreach(methtml_getarray($lang_shang,'',hits,'','$lang_gui_num','','','','16') as $key=>$val){
echo <<<EOT
-->
						<span class="item">
...
-->
						<!--<span class="item">
							<img src="{$img_url}img/guihua/market-case2.jpg" alt="">
							<span class="describe">
								<div class="vessel">
									<p class="tip">蜗牛生活体验馆</p>
									<p class="address">
										<img class="icon_li" src="{$img_url}img/guihua/market_case_li.png" alt="">	地址 : 兰州 <img class="icon_li" src="{$img_url}img/guihua/market_case_li.png" alt=""> 设计面积 : 6000㎡
									</p>
									<p class="link"><a href="">展示详情 | <img class="arrow" src="{$img_url}img/guihua/market_case_arrow.png" alt=""> </a></p>
								</div>
							</span>
						</span>
						<span class="item">
							<img src="{$img_url}img/guihua/market-case3.jpg" alt="">
							<span class="describe">
								<div class="vessel">
									<p class="tip">南瓜公社商业体</p>
									<p class="address">
										<img class="icon_li" src="{$img_url}img/guihua/market_case_li.png" alt="">	地址 : 鹤壁 <img class="icon_li" src="{$img_url}img/guihua/market_case_li.png" alt=""> 设计面积 : 30000㎡
									</p>
									<p class="link"><a href="">展示详情 | <img class="arrow" src="{$img_url}img/guihua/market_case_arrow.png" alt=""> </a></p>
								</div>
							</span>
						...
						<span class="item">
							<img src="{$img_url}img/guihua/market-case4.jpg" alt="">
							<span class="describe">
								<div class="vessel">
									<p class="tip">SE商业综合体</p>
									<p class="address">
										<img class="icon_li" src="{$img_url}img/guihua/market_case_li.png" alt="">	地址 : 苏州 <img class="icon_li" src="{$img_url}img/guihua/market_case_li.png" alt=""> 设计面积 : 6000㎡
									</p>
									<p class="link"><a href="">展示详情 | <img class="arrow" src="{$img_url}img/guihua/market_case_arrow.png" alt=""> </a></p>
								</div>
							</span>
						...
						<span class="item">
							<img src="{$img_url}img/guihua/market-case5.jpg" alt="">
							<span class="describe">
								<div class="vessel">
									<p class="tip">淮安商业综合体</p>
									<p class="address">
										<img class="icon_li" src="{$img_url}img/guihua/market_case_li.png" alt="">	地址 : 淮安 <img class="icon_li" src="{$img_url}img/guihua/market_case_li.png" alt=""> 设计面积 : 14285㎡
									</p>
									<p class="link"><a href="">展示详情 | <img class="arrow" src="{$img_url}img/guihua/market_case_arrow.png" alt=""> </a></p>
								</div>
							</span>
						...
						<span class="item">
							<img src="{$img_url}img/guihua/market-case6.jpg" alt="">
							<span class="describe">
								<div class="vessel">
									<p class="tip">云创谷商业综合体</p>
									<p class="address">
										<img class="icon_li" src="{$img_url}img/guihua/market_case_li.png" alt="">	地址 : 黑龙江 <img class="icon_li" src="{$img_url}img/guihua/market_case_li.png" alt=""> 设计面积 : 120000㎡
									</p>
									<p class="link"><a href="">展示详情 | <img class="arrow" src="{$img_url}img/guihua/market_case_arrow.png" alt=""> </a></p>
								</div>
							</span>
		...
		<div class="market-quality">
			...
			<div class="content">
				<div class="item_oval">
					<img class="list icon" src="{$img_url}img/guihua/market_profession_team.png" alt="">
				...
				<div class="item_oval">
					<img class="list icon" src="{$img_url}img/guihua/market_profession_design.png" alt="">
				...
				<div class="item_oval">
					<img class="list icon" src="{$img_url}img/guihua/market_profession_orginal.png" alt="">
				...
				<div class="item_oval">
					<img class="list icon" src="{$img_url}img/guihua/market_profession_brand.png" alt="">
				...
				<div class="item_oval">
					<img class="list icon" src="{$img_url}img/guihua/market_profession_gold.png" alt="">
		...
		<div class="market-know">
			<div class="shade">
				<div class="shade-content">
					...
					<!-- <p class="know-haian"><a href="">了解海岸</a></p> -->
				</div>
			</div>
		</div>
