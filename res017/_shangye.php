...
-->
{$methtml_head} 
<link rel="stylesheet" href="{$img_url}css/heti.css"/>
...
<script type="text/javascript" src="{$img_url}js/heti.js"></script>
 <div class="faer_top" >
            <div class="fixednav">
...
<header>
    <div class="bannermain">
      <img  style="padding-left: 6px;" src="{$img_url}heti/bannimg.png"/>
      <p>300人精英设计团队，18年行业品牌领军者</p>
    </div>
    <p>全国免费服务热线：400-879-1110</p>
    <div class="bannbigblue">
      <div class="lfbblue"></div> 
      <div class="bannblue"><a href="javascript:;" onclick="jQuery('.boxbig').show()" class="show">立即<br>预约</a></div> 
    </div> 
  </header>
  <div class="busitit">
    <h2 class="cntit">服务内容</h2>
    <h2 class="engtit">CLASSIFIED CONTENT</h2>
  </div>
  <div class="cexpansion">
    <ul class="strentchlist">
      <li><a href="http://www.haianzhuangshi.com/product/product.php?lang=cn&class2=114" target="_blank"><div class="barbar1"><h3><img class="upicon03" src="{$img_url}heti/upicon03.png">建筑景观<img class="downicon03" src="{$img_url}heti/downicon03.png"></h3></div></a></li>
      <li><a href="http://www.haianzhuangshi.com/product/product.php?lang=cn&class2=150" target="_blank"><div class="barbar1"><h3><img class="upicon03" src="{$img_url}heti/upicon03.png">酒店设计<img class="downicon03" src="{$img_url}heti/downicon03.png"></h3></div></a></li>
      <li><a href="http://www.haianzhuangshi.com/product/product.php?lang=cn&class2=145" target="_blank"><div class="barbar1"><h3><img class="upicon03" src="{$img_url}heti/upicon03.png">品牌餐饮<img class="downicon03" src="{$img_url}heti/downicon03.png"></h3></div></a></li>
      <li class="strentchli"><a href="http://www.haianzhuangshi.com/product/product.php?lang=cn&class2=119" target="_blank"><div class="barbar1"><h3><img class="upicon03" src="{$img_url}heti/upicon03.png">商业综合体<img class="downicon03" src="{$img_url}heti/downicon03.png"></h3></div></a></li>
      <li><a href="http://www.haianzhuangshi.com/product/product.php?lang=cn&class3=170" target="_blank"><div class="barbar1"><h3><img class="upicon03" src="{$img_url}heti/upicon03.png">会所设计<img class="downicon03" src="{$img_url}heti/downicon03.png"></h3></div></a></li> 
      <li><a href="http://www.haianzhuangshi.com/product/product.php?lang=cn&class2=147" target="_blank"><div class="barbar1"><h3><img class="upicon03" src="{$img_url}heti/upicon03.png">办公产业园区<img class="downicon03" src="{$img_url}heti/downicon03.png"></h3></div></a></li>
      <li><a href="http://www.haianzhuangshi.com/shudian" target="_blank"><div class="barbar1"><h3><img class="upicon03" src="{$img_url}heti/upicon03.png">书店设计<img class="downicon03" src="{$img_url}heti/downicon03.png"></h3></div></a></li>
      <li><a href="http://www.haianzhuangshi.com/product/product.php?lang=cn&class2=182" target="_blank"><div class="barbar1"><h3><img class="upicon03" src="{$img_url}heti/upicon03.png">软装配饰<img class="downicon03" src="{$img_url}heti/downicon03.png"></h3></div></a></li>
    </ul>
  </div>
  <div class="busitit">
  ...
  <div class="avegentbox">
      ...
      、新技术的应用。是国内少数能将气象数据应用在采光设 
        ...
        <p class="rgtbt001">海岸设计团队，针对酒店、商业综合体、会所、办公等提供软装
        ...
        <div class="avegcenter">
          ...
          <img class="centeravg" src="{$img_url}heti/avgcen00.png"/>
          <img class="ltavg" src="{$img_url}heti/avgcen01.png"/>
          <img class="rtavg" src="{$img_url}heti/avgcen02.png"/>
          <img class="lbavg" src="{$img_url}heti/avgcen03.png"/>
          <img class="rbavg" src="{$img_url}heti/avgcen04.png"/>
          <div class="udhr">
            <p>我们的优势</p>
          </div>
        </div>
  ...
  <div class="usensurebox">
    ...
    <div class="usensuremain">
      <ul class="ensureul">
        <li><i><img src="{$img_url}heti/ensureicon1.png" alt="实力设计"></i><div class="ensureulcenter"><em>实力设计</em><p>行业大咖设计，拒绝伪资深</p></div></li>
        <li><i><img src="{$img_url}heti/ensureicon2.png" alt="保证原创"></i><div class="ensureulcenter"><em>保证原创</em><p>以归本主义风格100%原创</p></div></li>
        <li><i><img src="{$img_url}heti/ensureicon3.png" alt="品牌定制"></i><div class="ensureulcenter"><em>品牌定制</em><p>高端私人订制，尽显品牌个性</p></div></li>
        <li><i><img src="{$img_url}heti/ensureicon4.png" alt="完美售后"></i><div class="ensureulcenter"><em>完美售后</em><p>多年完美良心服务，满意为止</p></div></li>
      </ul>
...
自然光下的折纸将成为创造和谐紧密的建筑外轮廓，边边角角，条条框框，有意无意间，都在体现对极致生活的追求
                    ...
                    <div id='pic'>
                      <li class='l1'><img src="{$img_url}heti/1_03.jpg" alt="" /></li>
                      <li class='l2'><img src="{$img_url}heti/2_03.jpg" alt="" /></li>
                      <li class='l3'><img src="{$img_url}heti/3_03.jpg" alt="" /></li>
                      <li class='l9'><img src="{$img_url}heti/4_03.jpg" alt="" /></li>
                      <li class='l0'><img src="{$img_url}heti/5_03.jpg" alt="" /></li>
                    </div>
                    <div id="btn">
                      <div id="left"></div>
                      <div id="right"></div>
   ...
   <img src="{$img_url}heti/aboouter.jpg">
     ...
     <div class="aboutrgtbtn"></div>
      ...
      <div class="heticaseshowbox">
          <div class="heticaseshow">
              <div class="heticasepic">
                  <ul>
                    <li><img src="{$img_url}heti/hetiimglinbo1.jpg" alt="北京海岸商业综合体设计案例"></li>
                    <li><img src="{$img_url}heti/hetiimglinbo2.jpg" alt="北京海岸商业综合体设计案例"></li> 
                  </ul>
                   
              </div>
              <div class="heticasetxt">
                  <span>COMMERCIAL COMPIEX</span>
                  <em>商业综合体</em>
                  <hr class="hetishowhr">
                  <p>
                      海岸提供全面的商业设计服务<br>
海岸商业设计，国内商业空间规划设计机构，致力于商业空间设计、商业规划及商业策划，为客户提供专业系统的商业策划、建筑设计、商业规划、空间设计等集成设计支持服务。<br>
海岸设计，致力于打造商业设计行业的领军品牌。 海岸有针对性地为不同地域、不同类型的项目提供专业、完善的设计支持，经过多年的风雨历程，海岸积累了丰富的设计实践经验以及一大批精锐高能的设计人才。
                  </p><a href="http://www.haianzhuangshi.com/product/product.php?lang=cn&class2=119" target="_blank">
      ...
      <div class="linianbox">
          ...
          <div class="linianpbox">
            <p>商业综合体创造了一种类似于城市的场所，它的目的是要为人们提供具有多元复合功能的城市空间。商业综合体的变化由小变大，有简单到纷繁。我们捕捉时代的元素、历史的印记，实现着生活的美好，让每位到店的顾客留下美好的记忆，成为城市生活中不可缺失的组成部分。 
商业规划——商业综合体设计的根基，无论是独立商铺、超级市场、百货店、购物中心，所有的商业综合体都要实现它的功能。不同的空间对通道设置、楼层业态安排、平行交通组织、垂直交通组织公共空间的尺度控制，有着不同的要求。我们的团队在积淀中实现传承和发展。 
商业空间——实现商业综合体的功能，除了平面上给予它面积、通道、人流、物流的设计，我们更赋予它生命和主题，使区域氛围更鲜活，功能更强大。我们针对吊顶、地坪、照明、公共区域公共设施、情景点、休息区等空间区域，办公室装修、造型、材质、照明等手法，实现区域
功能的体现和延伸。<br>
商业格局——实现商业功能，最终组成的核心是商品。不同的商品对其商业格局的要求不尽相同，实现商品陈列，突出商品特点，才能实现功能的转化。在商业综合体空间中，除了顶、地、柱、墙等空间围合要素外，商业综合体空间是否通透、是否丰富、是否大气，都是我们要解决的问题。我们针对不同区域、不同商品，运用整场透视的手法，实现商品陈列和氛围的完美统一。</p>
