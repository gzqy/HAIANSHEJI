<?php
//反馈提交表单函数
function metlabel_feedback4($fid,$mobile){
	...
	switch($list[type]){
	case 1:
	$list[input]="<div class='footer_iptline'><input name='para$list[id]' type='text' size='30'  class='liu'placeholder='{$list[description]}' /></div>";
	break;
	case 2:
    ...
    foreach($fd_para as $key=>$val){
     ...
     $metinfo.="<div class='footer_intbtn'><input type='submit' name='Submit' value='提交' class='fas'></div>\n";
     $metinfo.="</form>\n";
	}
	return $metinfo;
}
