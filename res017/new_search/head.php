<!--<?php
require_once template('new_search/meta');
if($lang_navfixedok){
...
<!--
EOT;
if($_M['url']['shop'])require_once template('new_search/shop_head_user');
require_once template('new_search/topnav');
echo <<<EOT
-->
				</div>
			</div>
...
<!--
EOT;
if(!$bannernone)require_once template('new_search/banner');
if(!$index&&!$sidebarnone)require_once template('new_search/sidebar');
?>