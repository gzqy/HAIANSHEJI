...
echo <<<EOT
-->	
							<li class='visible-xs'><a href="{$val[url]}" {$val[new_windows]} title="{$navname}" class="">{$navname}</a></li>
<!--
EOT;
}
echo <<<EOT
...
-->
							<li class="dropdown-submenu">
								<a href="{$val2[url]}" class="{$navnow} animation-fade" {$val2[new_windows]} role="button" tabindex="-1">{$val2[name]}<i class="fa fa-angle-right"></i></a>
...
echo <<<EOT
-->
									<li role="presentation"><a href="{$val3[url]}" class="{$navnow} animation-fade" role="menuitem" tabindex="-1">{$val3[name]}</a></li>
<!--
EOT;
			}
echo <<<EOT
...
echo <<<EOT
-->
							<li class="animation-fade animation-delay-{$y}"><a href="{$val2[url]}" class="{$navnow} animation-fade " {$val2[new_windows]} title="{$val2[name]}">{$val2[name]}</a></li>	
<!--
EOT;
		}
	}
...
echo <<<EOT
-->
					<li class="margin-left-{$lang_navmarginleft}"><a href="{$val[url]}" {$val[new_windows]} title="{$val[name]}" class="link {$navnow} animation-zoomIn">{$val[name]}</a></li>
<!--
EOT;
	}
echo <<<EOT
