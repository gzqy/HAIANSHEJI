...
function ready(){
	$('.boutiqueCenter li').on({
		mouseover : function(){
			...
			$(this).find('.hive').css({top:'395px',opacity:1})
		},
		mouseout : function(){
	...
	$('.c-abstract div').on({
		mouseover : function (){
			$(this).find('li:nth-child(1)').addClass('merge');
			$(this).siblings().find('li.merge').removeClass('merge');
			$(this).find('div').css({backgroundColor:'#2095a3',color:'#fff'})
		},
		mouseout : function (){
			$(this).find('div').css({backgroundColor:'#fff',color:'#333333'})
			$(this).find('li:nth-child(1)').removeClass();
			$('.look li:first-child').addClass('merge');
		}
	})
	$('.ment ul li').on({
		mouseover : function(){
	...
	$('.tem_index_news_list_txt ').on({
		mouseover : function (){		
			$(this).find('hr:nth-child(2)').css({width:'340px',opacity:1,transtion:'2s all'});
		},
		mouseout : function(){
			$(this).find('hr:nth-child(2)').css('width','10px');
		}
	})
	slide();
}
...
function slide(){
	$(window).scroll(function(){
		if($(window).scrollTop()>100){
			$('.slide-1').addClass('animated flipInX');
			$('.slide-2').addClass('animated flipInX');
			$('.slide-3').addClass('animated flipInX');
			$('.slide-4').addClass('animated flipInX');
			$('.slide-5').addClass('animated flipInX');
		}
		if($(window).scrollTop()>600){
			$('.abroad').addClass('animated zoomIn');
		}
		if($(window).scrollTop()>4200){
			$('.retreat-text p').addClass('animated rotateIn');
		}
	})
}
...
$(function(){
	...
	$('.tem_index_news_tab li').bind('click',function(){
		...
		$(this).children('h3').css({backgroundColor:"#8c989f",color:"black"}).parent().siblings().children('h3').css({backgroundColor:"#fff",color:"black"});
		if(index>0){
