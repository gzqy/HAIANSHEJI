...
function Cool(){
	$('.reach').css({'backgroundSize':'100% 100%'})
	 $('.reach-xian').css({'transform': 'scale(1)',opacity:1,width:'1322px',height:'600px',visibility: 'visible'})
	
    setTimeout(function(){
		$('.top').animate({width:'1320px'},2400)
		$('.left').animate({height:'600px'},2400)
        $('.right').animate({height:'600px'},2400)
        $('.bottom').animate({ width:'1320px'},2400)
    })
