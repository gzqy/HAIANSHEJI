...
$(function(){
	$('.bannertopp').animate({top: '150px', opacity: 1}, 800);
	$('.bannerul').animate({top: '428px', opacity: 1}, 800);
	$('.wangkalianxibtn').animate({opacity: 1 , paddingTop:'0'}, 700);
	$('.bannertitle').animate({opacity: 1}, 1200);
})
//当屏幕滚动到第二屏，缓慢出现
$(function(){  
    // var flag=true;
