...
//关于我们部分获取P高度
// $(function(){
//   var c2liemtop=$(".haianjieshao em").css("height");
...
$(function(){
  ...
  // var _piccount;
  var _automove;
  _clalen=$('.heticasepic ul li').length;
  // $('.hetichangebtnleft').click(function(){
  //   clearInterval(_automove);
  //   $('.heticasepic ul li').eq(clai).fadeOut(1000);
  //   clai--;
  //   if(clai<0){
  //     clai=_clalen-1;
  //     $('.heticasepic ul li').eq(clai).fadeIn(1000);
  //   }else{
  //     $('.heticasepic ul li').eq(clai).fadeIn(1000);     
  //   }
  // },function(){
  ...
  // });
  // $('.hetichangebtnright').click(function(){
  //   clearInterval(_automove);
  //   $('.heticasepic ul li').eq(clai).fadeOut(1000);
  //   clai++;
  //   if(clai==_clalen){
  ...
  **/
  function movenext(_index){
      ...
      $('.heticasepic ul li').eq(_picCurrentIndex).fadeIn(1000);
      $('.heticasepic ul li').eq(_picPreIndex).fadeOut(1000);
  }
})
