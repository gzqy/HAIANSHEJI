...
$(function(){
	setTimeout(function(){
		$('.banner_globel .bg_top').animate({top:0,opacity:1},800);
		$('.banner_globel .bg_center').animate({top:'296px',opacity:1},800,function(){
			$('.banner_globel .bg_bottom').animate({top:'108px',opacity:1},500);
			$('.banner_button').animate({top:'-20px',opacity:1},500);
		});
	},800);
});