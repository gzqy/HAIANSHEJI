...
-->
{$methtml_head} 
<link rel="stylesheet" type="text/css" href="{$img_url}css/shangye.css"/>
...
<link rel="stylesheet" type="text/css" href="{$img_url}css/slide_sySc.css">    
    ...
    <div class="headertxt">
      <hr class="hrone" />
      <img src="{$img_url}mall/shangye/b-z.png" alt="Commercial complex design">
      <em class='headeroneem'><img src="{$img_url}mall/shangye/bannertitle.png" alt="商业综合体设计"></em>
      <em class='headertwoem'><img src="{$img_url}mall/shangye/bannertxt.png" alt="19年行业领先品牌，300位设计团队精英"></em>
      <hr class="hrtwo" />
    </div>
    <em class='headerthreeem'><img src="{$img_url}mall/shangye/banner-zi.png" alt="400电话"></em>
    <a href="javascript:void(0);" onclick="jQuery('.boxbig').show()"><button>立即预约</button></a>
  </header>
      ...
      <div class="malldesignservices">
          ...
          <div class="designctntop">
              <div class="designfenmainheng">
                  <i><img src="{$img_url}mall/degnnumber02.png" alt="城市副中心"></i>
                  <em>城市副中心</em>
                  <a href="javascript:;" onclick="jQuery('.boxbig').show()"><button>立即预约</button></a>
              </div>
          </div>
          <div class="designctndwnlft">
              <div class="designfenmainshu designfenmainshuxiao">
                  <i><img src="{$img_url}mall/degnnumber03.png" alt="交通枢纽"></i>
                  <em>交通枢纽</em>
                  <a href="javascript:;" onclick="jQuery('.boxbig').show()"><button>立即预约</button></a>
              </div>
          </div>
          <div class="designrgtone">
              <div class="designfenmainshu">
                  <i><img src="{$img_url}mall/degnnumber04.png" alt="CBD"></i>
                  <em>CBD</em>
                  <a href="javascript:;" onclick="jQuery('.boxbig').show()"><button>立即预约</button></a>
              </div>
          </div>
...
布局方案，为后续招商、设计工作和项目成功运营奠定基础。</p>
      ...
      <div class="forimagepos">
        <div class="positionimagebox imageboxone">
          ...
          <em>商业综合体形象定位</em>
          <p>商业综合体的形象定位，实际上是商业综合体经营企业的形象定位<br>  
  它随着商业综合体的经营运作而持续存在并发挥作用，通过对商业中心品牌的定位界定商业文化内涵，建立超前的品牌形象<br> 
  引领购物时尚、反映地域特色、精选服务对象、创新组合业态、综合形象鲜明且易推广传播等<br> 
  从战略高度上系统设计和推出专业化商业综合体规划设计/商业广场设计是完全必要的选择</p>
      ...
      <div class="planprinciple">
        <div class="planprinciplelft">
          <img src="{$img_url}mall/planprinciplelftpic.jpg" >
          <p>       一个商业综合体的形成有其城市发展的历史背景， 也各有其特色，并在现代城市的建设中不断调整、完善，以适应现代人的新生活需要。商业建筑必须具有立体化、网络化的交  通，以保证交通通达性好。商业街的行业结构应是三足鼎立，以满  足消费者多层次多方位的需求。商业街应具有独特的商业魅力和传统与现代相结合的文化气息。商业街必须突出整体协调性和人性化 设计和营造园林景观的基础。</p>
        </div>
        <div class="planprinciplergt">
          <img src="{$img_url}mall/planprinciplelistline.png" >
          <dl>
            <dt>１、地下商城：力求通过高差、出入口、局部广场下沉营造负1层商业门面的价值最大化。</dt>
            <dt>２、步行街系统沿景观轴线东西向依次布局，传统商业街区的提升和升华，有机融合到综合体功能的各个细节中。</dt>
            <dt>３、核心主力店，应注意与项目总体建筑风格的统一，店内考虑水平与垂直动线有机结合，达成商业动线规划的完整。</dt>
            <dt>４、住宅、公寓。所有住宅楼的底层（即建筑的第5层）架空为花园。 </dt>
            <dt>５、停车场所主要设置在两住宅裙楼下的负2层，设不同出入口。设备用房放于负2层，商业储藏室布置于负1层。</dt>
            <dt>６、项目环四周设计步行街道，以解决部分交通组织需要，并同时最大可能制造临街商铺。</dt>
            <dt>７、景观设计中，不仅注重文化标志，更应一人文本，注重盲道、残疾人通道的无障碍设计，人行和交通道路、社区服务设施、街区照明设施、步行街环境等等。 </dt>
          </dl>
        </div>
      </div>
      ...
      <ul class="classiccase">
        <li>
          <div class="casetoppicbox">
              ...
              <a href="{$index_url}product/39-cn.html" target="_blank" title="蜂巢商业综合体设计" alt="蜂巢商业综合体设计"><img src="{$img_url}mall/casetoppic01.jpg" alt="北京海岸设计"></a>
        ...
        <li>
          <div class="casetoppicbox">
              ...
              <a href="{$index_url}product/37-cn.html" target="_blank" title="蜗牛生活商业综合体设计" alt="蜗牛生活商业综合体设计"><img src="{$img_url}mall/casetoppic02.jpg" alt="北京海岸设计"></a>
              <i><img src="{$img_url}mall/linkicon.png" alt="链接图标"></i>
          </div>
          <span class="orangebgspan"></span>
          <em>蜗牛生活体验馆设计</em>
        ...
        <li>
          <div class="casetoppicbox">
              ...
              <a href="{$index_url}product/475-cn.html" target="_blank" title="南瓜公社商业综合体设计" alt="南瓜公社商业综合体设计"><img src="{$img_url}mall/casetoppic03.jpg" alt="北京海岸设计"></a>
              <i><img src="{$img_url}mall/linkicon.png" alt="链接图标"></i>
          </div>
          <span class="orangebgspan"></span>
          <em>南瓜公社商业体设计</em>
        ...
        <li>
          <div class="casetoppicbox">
              ...
              <a href="{$index_url}product/105-cn.html" target="_blank" title="SE商业综合体设计" alt="SE商业综合体设计"><img src="{$img_url}mall/casetoppic04.jpg" alt="北京海岸设计"></a>
              <i><img src="{$img_url}mall/linkicon.png" alt="链接图标"></i>
          </div>
          <span class="orangebgspan"></span>
          <em>SE商业综合体设计</em>
        ...
        <li>
          <div class="casetoppicbox">
              ...
              <a href="{$index_url}product/347-cn.html" target="_blank" title="云创谷商业综合体设计" alt="云创谷商业综合体设计"><img src="{$img_url}mall/casetoppic06.jpg" alt="北京海岸设计"></a>
              <i><img src="{$img_url}mall/linkicon.png" alt="链接图标"></i>
          </div>
          <span class="orangebgspan"></span>
          <em>云创谷商业综合体设计</em>
      ...
      <div class="forprofessional">
        <div class="positionimagebox imageboxthree">
          ...
          <span class="potiondedwn"></span>
          <em>品质源于专业</em>
          <pre>自信源于我们对产品质量的一贯苛求，我们五大保障的保障，升华后的空间让您更为满意</pre>
...
<script src="{$img_url}js/jquery-3.3.1.min.js" type="text/javascript"></script>
<script src="{$img_url}js/slide_new.js" type="text/javascript"></script>
<script type="text/javascript" src="{$img_url}js/shangye.js"></script>
