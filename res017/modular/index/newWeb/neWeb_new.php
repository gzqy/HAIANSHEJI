...
$tem_news[0]['list']   = methtml_getarray($lang_home_news_id,$lang_home_news_type,'','',$lang_home_news_num);
...
$tem_news[1]['list']   = methtml_getarray($lang_home_design_id,'','','',$lang_home_news_num);
...
$tem_news[2]['list']   = methtml_getarray($lang_home_haianNews_id,'','','',$lang_home_news_num);
...
-->
	<div class="met-index-news met-index-body" style="background-color: #fff !important">
		<div class="tem_inner">
			<h3 class="neWeb_title invisible" data-plugin="appear" data-animate="fade" data-repeat="false"><span class="red">海岸</span>动态</h3>
			<hr>
			...
			<p class="neWeb_new_desc invisible animation-delay-200" data-plugin="appear" data-animate="fadeInDown" data-repeat="false">{$lang_home_news_desc}</p>
