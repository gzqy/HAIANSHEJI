...
echo <<<EOT
-->
	<div class="met-index-news met-index-body" style="background-color: #221e1b !important">
	<a class="target_fix" id="productsseven"></a>
		<div class="tem_inner">
			<h3 class="neWeb_title invisible" data-plugin="appear" data-animate="fade" data-repeat="false">海岸动态</h3>
			<p class="neWeb_new_desc invisible animation-delay-100" data-plugin="appear" data-animate="fadeInDown" data-repeat="false"><!--{$lang_home_news_subtitle}-->业务覆盖全国70%省份，累计设计餐厅超过50,000平米 ... 全国免费咨询热线 400-879-1110</p>
			<p class="neWeb_new_desc invisible animation-delay-200" data-plugin="appear" data-animate="fadeInDown" data-repeat="false"></p>
